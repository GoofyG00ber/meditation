    ...
    <div class="container mx-auto px-6 py-12">
      <div class="max-w-md mx-auto bg-white rounded-2xl p-8 shadow-lg">
        ...
        <form @submit.prevent="handleRegister" class="space-y-6">
          ...
          <div>
            <label for="confirmPassword" class="block text-sm font-semibold text-gray-700 mb-2">Jelszó megerősítése</label>
            <input
              id="confirmPassword"
              ...
              placeholder="••••••••"
            />
            <p v-if="formData.password && formData.confirmPassword && formData.password !== formData.confirmPassword" class="text-xs text-red-500 mt-1">A jelszavak nem egyeznek</p>
          </div>
